    ...
    <Container maxW="8xl">
      ...
      <SimpleGrid columns={{ base: 1, md: 3 }} spacingX="10" spacingY="14">
        <Feature
          ...
          dates="sep. 2018 - now"
        >
          IT Consultant company specialized in blockchain technology
        </Feature>
        <Feature
          company="BCode"
          title="Software Architect"
          icon={<Image w="40px" src={BCode} />}
          dates="nov. 2020 - now"
        >
        ...
        <Feature
          ...
          icon={<Image w="55px" src={Satellite} />}
          dates="dec. 2020 - now"
        >
          Decentralized messaging and chat platform
        </Feature>
      </SimpleGrid>
    </Container>
  </Box>
